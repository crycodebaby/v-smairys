...
export function CampaignDetail({ vm }: CampaignDetailProps) {
  ...
  return (
    <div key={campaign.slug} className="animate-panel-in flex flex-col gap-5">
      ...
      <GlassCard label="Plausible" title="Reporting (keine Zahlen im Dashboard)">
        <p className="text-sm leading-relaxed text-foreground/70">
          Besucher und Conversions siehst du ausschließlich in Plausible – nicht hier.
          Filter: <span className="text-foreground/90">Top Sources → Campaigns</span> nach{" "}
          <code className="rounded bg-white/[0.08] px-1.5 py-0.5 font-mono text-[11px] text-foreground/85">
